 ...
 */
define("PAGE_TITLE", "Fondeos Solicitados por Aliados");
define("DESCRIPTION", "Administración de los préstamos solicitados dentro de la empresa.");
									...
									<div class="box-body">
										<div class="tabbable header-tabs">
											<ul class="nav nav-tabs">
												...
												<li class="active"><a href="#box_tab1" data-toggle="tab"><i class="fa fa-usd"></i> <span class="hidden-inline-mobile">Fondeos</span></a></li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade in active" id="box_tab1">
													<table id="table-prestamos" class="dataTable"> 
														<thead>	
															<tr>
																<th align="center">No.</th>
																<th align="center">Fecha de Alta</th>
																<th align="center">Acreditante</th>
														...
														<tfoot>
															<tr>
																...
																<th rowspan="1" colspan="1">Fecha de Alta</th>
																<th rowspan="1" colspan="1">Acreditante</th>
																<th rowspan="1" colspan="1">Monto</th>
																<th rowspan="1" colspan="1">Plazo</th>
																<th rowspan="1" colspan="1">Tasa</th>
																<th rowspan="1" colspan="1">Frecuencia de Pagos</th>
																<th rowspan="1" colspan="1">Intereses</th>
