 ...
 */
define("PAGE_TITLE", "Abonar Pagos Individuales");
define("DESCRIPTION", "Módulo encargado de verificar el pago de cada uno de los Acreditados");
			...
			<div class="container">
				<div class="row">
					<div id="content" class="col-lg-12">
						...
						<form id="filtro">
							<div class="col-sm-10">
								<input type="text" name="cliente" id="cliente" class="form-control" placeholder="Seleccione el cliente que desea abonar.">
								<input type="hidden" name="credito" id="credito">
							</div>
							<div class="col-sm-2">
								<a class="buscar pull-left" href="#" data-id="">
