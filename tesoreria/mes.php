				...
				<div class="row">
					<div id="content" class="col-lg-12">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<div class="pull-left">
										<div class="clearfix">
											<h3 class="content-title pull-left"><?php echo(PAGE_TITLE); ?> - <span class="mes_title"></span> <?php echo $_GET['y'];?></h3>
										</div>
									...
									<div class="box-body">
										<div class="tabbable header-tabs">
											<ul class="nav nav-tabs">
												...
												<li class="active"><a href="#box_tab1" data-toggle="tab"><i class="fa fa-usd"></i> <span class="hidden-inline-mobile">Gastos</span></a></li>
											</ul>
											<div class="tab-content">
												<input type="text" class="display-none" id="mes" value="<?php echo isset($_GET['m']) ? $_GET['m'] : '-1' ; ?>">
													...
													<table id="table-usuario" class="dataTable"> 
														<thead>	
															<tr>
																...
																<th align="center">Tipo de Gasto</th>
																<th align="center">Concepto</th>
																<th align="center">Factura</th>
																<th align="center">Bancarizado / Efectivo</th>
														...
														<tfoot>
															<tr>
																...
																<th rowspan="1" colspan="1">Tipo de Gasto</th>
																<th rowspan="1" colspan="1">Concepto</th>
																<th rowspan="1" colspan="1">Factura</th>
																<th rowspan="1" colspan="1">Bancarizado / Efectivo</th>
						...
						<div class="row">
							<div class="col-md-12">
								<form id="form">
									<input type="text" class="display-none" id="mes" name="m" value="<?php echo isset($_GET['m']) ? $_GET['m'] : '-1' ; ?>">
									<input type="text" class="display-none" id="anio" name="y" value="<?php echo isset($_GET['y']) ? $_GET['y'] : '-1' ; ?>">
									<table id="table-month" class="table table-striped table-hover">
										<thead>
											<tr>
												<th align="center">#</th>
												<th align="center">Fecha</th>
												<th align="center">Entrada / Salida / Gasto</th>
											...
											<tr>
												...
												<th align="center"></th>
												<th>
													<select class="form-control" name="esg" id="esg">
												...
												<th>
													<select class="form-control" name="tipo" id="tipo">
														<option value="-1">Todas los Tipos</option>
												...
												<th>
													<input type="text" name="grupo" id="grupo" class="form-control" placeholder="Grupo">
												</th>
												<th class="cont-promotor" align="center">
													<select id="promotor" class="form-control" disabled>
														<option value='0'>Cargando...</option>
													</select>
												</th>
												<th>
													<select class="form-control" name="be" id="be">
														<option value="-1">Todos</option>
														<option value="Bancarizado">Bancarizado</option>
