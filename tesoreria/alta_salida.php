 ...
 */
define("PAGE_TITLE", "Nueva Salida");
define("DESCRIPTION", "Alta de nueva Salida");
			...
			<div class="container">
				<div class="row">
					<div id="content" class="col-lg-12">
						...
						<div class="row">
							<div class="col-md-12">
								<form class="form-horizontal" id="form-salida" name="form-salida" action="include/Libs.php/accion=saveSalida">
									<div class="row">
										<div class="col-md-11 center-box-11">
											...
											<div class="box border primary">
												...
												<div class="box-body big">
													...
													<div class="form-group">	
														<label class="col-sm-2 control-label">Monto Total del Crédito</label>
														<div class="col-sm-4">
															<div class="input-group">
																<span class="input-group-addon">$</span>
																<input id="credito" name="credito" type="text" class="form-control" readonly="readonly">
															</div>
														</div>
