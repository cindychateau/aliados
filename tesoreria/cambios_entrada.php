 ...
 */
define("PAGE_TITLE", "Editar Entrada");
define("DESCRIPTION", "Edición de Entrada");
			...
			<div class="container">
				<div class="row">
					<div id="content" class="col-lg-12">
						...
						<div class="row">
							<div class="col-md-12">
								<form class="form-horizontal" id="form-entrada" name="form-entrada" action="include/Libs.php/accion=saveEntrada">
											...
											<div class="box border primary">
												...
												<div class="box-body big">
													<div class="form-group">
														...
														<label class="col-sm-2 control-label">Tipo de Entrada</label>
														<div class="col-sm-5">
															<select id="tipo" name="tipo" class="form-control">
																<option value="Pago Semanal de Crédito">Pago Semanal de Crédito</option>
																<option value="Finiquito de Crédito">Finiquito de Crédito</option>
															</select>
														</div>
												  	</div>
												  	<div class="form-group">
														...
														<div class="col-sm-5 cont-promotor">
															<select id="promotor" name="promotor" class="form-control" disabled="disabled">
																<option value="0">Cargando...</option>
															</select>
														</div>
													</div>
													<div class="form-group">	
														<label class="col-sm-2 control-label">Pago Semanal Correspondiente</label>
														<div class="col-sm-4">
															<div class="input-group">
																<span class="input-group-addon">$</span>
																<input id="pago_correspondiente" name="pago_correspondiente" type="text" class="form-control" readonly="readonly">
															</div>
														</div>
