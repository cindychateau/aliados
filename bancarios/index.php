 ...
 */
define("PAGE_TITLE", "Apertura de Créditos Bancarios");
define("DESCRIPTION", "Administración de los Créditos Bancarios Vigentes.");
					...
					<div id="content" class="col-lg-12">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="row">
									<div class="col-sm-6">
										<button class="btn btn-light-grey tipo" title="" data-value="1">Nuevo</button>
										<button class="btn btn-grey tipo" title="" data-value="2">Recrédito</button>
