 ...
 */
define("PAGE_TITLE", "Nuevo Grupo");
define("DESCRIPTION", "Alta de nuevo Grupo");
												...
												<div class="box-body big">
													...
													<div class="form-group">
												  	...
												  	<div class="form-group">
														...
														<div class="col-sm-4">
															<div class="input-group">
																<input id="tasa" name="tasa" type="text" class="form-control" value="1.76667">
												  	...
												  	<div class="form-group">
														...
														<div class="col-sm-4">
															<div class="input-group">
																<input id="ahorro_p" name="ahorro_p" type="text" class="form-control" value="0">
																<span class="input-group-addon">%</span>
															</div>
														</div>
