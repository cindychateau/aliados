 ...
 */
define("PAGE_TITLE", "Pago de Préstamos otorgados a Aliados");
define("DESCRIPTION", "Indicador de pagos de préstamos realizados a Aliados, así como el avance de cada uno.");
			...
			<div class="container">
				<div class="row">
					<div id="content" class="col-lg-12">
						...
						<div class="row">
							<!-- Avance de Pagos -->
							<div class="col-md-4 cont-panel">
								
							</div>
							<div class="col-md-8">
								<div class="box border blue">
									<div class="box-title">
										<h4><i class="fa fa-calendar"></i>Calendario de Pagos</h4>
									</div>
									<div class="box-body cont-table">
