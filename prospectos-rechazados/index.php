 ...
 */
define("PAGE_TITLE", "Prospectos Rechazados");
define("DESCRIPTION", "Administración de prospectos para los grupos.");
									...
									<div class="box-body">
										<div class="tabbable header-tabs">
											<ul class="nav nav-tabs">
												...
												<li class="active"><a href="#box_tab1" data-toggle="tab"><i class="fa fa-user-times"></i> <span class="hidden-inline-mobile">Prospectos Rechazados</span></a></li>
											</ul>
											<div class="tab-content">
												<div class="tab-pane fade in active" id="box_tab1">
													<table id="table-prospectos" class="dataTable"> 
														<thead>	
															<tr>
																...
																<th align="center">Monto Solicitado</th>
																<th align="center">Razón de Rechazo</th>
														...
														<tfoot>
															<tr>
																...
																<th rowspan="1" colspan="1">Monto Solicitado</th>
																<th rowspan="1" colspan="1">Razón de Rechazo</th>
