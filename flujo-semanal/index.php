 ...
 */
define("PAGE_TITLE", "Flujo Semanal");
define("DESCRIPTION", "Administración de los gastos, préstamos y pagos semanales.");
						...
						<div class="row">
							<div class="col-md-12">
								<div id="table-content">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="margin-bottom-15">
												<small>Seleccione Mes y Semana que desea consultar.</small>
											</div>
											<div class="col-md-4 cont-mes">
												<select id="mes" name="mes" class="form-control" disabled>
													<option value="0">Cargando...</option>
												</select>
											</div>
											<div class="pull-left col-md-4 cont-semana margin-bottom-15">
												<select id="semana" name="semana" class="form-control" disabled>
													<option value="0">Cargando...</option>
												</select>
											</div>
										</div>
									...
									<!-- /FILTROS -->
									<table id="table-flujo" class="dataTable table"> 
										<thead>	
											<tr>
