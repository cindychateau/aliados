...
define("DESCRIPTION", "Módulo encargado de verificar el pago de cada uno de los Acreditados en su respectivo Crédito Individual");
							  	...
							  	<div class="col-sm-6">
							  		<div class="form-group">
							  			<div class="input-group"> 
											<input type="text" class="form-control" name="cre_id" id="cre_id" placeholder="Ingrese Crédito">
