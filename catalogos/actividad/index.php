 ...
 */
define("PAGE_TITLE", "Catálogo Actividades Económicas");
define("DESCRIPTION", "Administración de Actividades Económicas que aparecen al dar de alta personas a acreditar.");
						...
						<div class="row">
							<div class="col-md-12">
								<div id="table-content">
									<table id="table-actividad" class="dataTable"> 
										<thead>
											<tr>
										...
										<tfoot>
											<tr>
												...
												<th rowspan="1" colspan="1">Actividad Económica</th>
