 ...
 */
define("PAGE_TITLE", "Nuevo Gasto");
define("DESCRIPTION", "Alta de nuevo Gasto");
			...
			<div class="container">
				<div class="row">
					<div id="content" class="col-lg-12">
						...
						<div class="row">
							<div class="col-md-12">
								<form class="form-horizontal" id="form-gastos" name="form-gastos" action="include/Libs.php/accion=saveRecord">
									<div class="row">
												...
												<div class="box-body big">
													<div class="form-group">
												  	...
												  	<div class="form-group">
														...
														<label class="col-sm-2 control-label">*Bancarizado / Efectivo</label>
														<div class="col-sm-4">
