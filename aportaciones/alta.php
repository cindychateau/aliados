 ...
 */
define("PAGE_TITLE", "Nueva Aportación");
define("DESCRIPTION", "Alta de nueva Aportación");
			...
			<div class="container">
				<div class="row">
					<div id="content" class="col-lg-12">
						...
						<div class="row">
							<div class="col-md-12">
								<form class="form-horizontal" id="form-aportacion" name="form-aportacion" action="include/Libs.php/accion=saveRecord">
									<div class="row">
											...
											<div class="box border primary">
												...
												<div class="box-body big">
													<div class="form-group">
												  	...
												  	<div class="form-group">
														<label class="col-sm-2 control-label">Concepto / Comentarios</label>
														<div class="col-sm-5">
