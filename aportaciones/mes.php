 ...
 */
define("PAGE_TITLE", "Aportaciones a la Empresa - ");
define("DESCRIPTION", "Administración de las apotaciones dentro de la empresa.");
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<div class="pull-left">
										<div class="clearfix">
											<h3 class="content-title pull-left"><?php echo(PAGE_TITLE); ?> <span><?php echo $_GET['c'];?></span></h3>
										</div>
										<div class="description"><span class="mes_title"></span> <?php echo $_GET['y'];?></div>
									</div>
									...
									<div class="box-body">
										<div class="tabbable header-tabs">
											<ul class="nav nav-tabs">
												...
												<li class="active"><a href="#box_tab1" data-toggle="tab"><i class="fa fa-usd"></i> <span class="hidden-inline-mobile">Aportaciones</span></a></li>
												<input type="hidden" id="c" value="<?php echo $_GET['c'];?>">
												<input type="hidden" id="m" value="<?php echo $_GET['m'];?>">
												<input type="hidden" id="y" value="<?php echo $_GET['y'];?>">
											</ul>
