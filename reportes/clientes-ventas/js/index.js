$(document).ready(function () {
    ...
    $(document).on('change','.fecha, #actividad',function(e) {
        e.preventDefault();
    ...
    $.ajax({
        ...
        success: function(result){
            if(result.error) {
                ...
                $(".table-ventas").html(result.table);
                $(".cont-loader").removeClass("loader");
                $("input, button").removeAttr("disabled");
            }
    ...
    $.ajax({
        ...
        success: function(result){
            if(result.error) {
                ...
                $(".cont-loader").removeClass("loader");
                $("input, button").removeAttr("disabled");
                $(".cont-guardar").html('<a href="include/clientes-ventas.xlsx"><button class="btn btn-success" title=""><i class="fa fa-save"></i> Guardar Excel</button></a>');
            }
