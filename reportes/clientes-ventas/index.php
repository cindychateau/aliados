 ...
 */
define("PAGE_TITLE", "Reporte de Clientes de Ventas");
define("DESCRIPTION", "");
			...
			<div class="container">
				<div class="row">
					<div id="content" class="col-lg-12">
						...
						<div class="row">
							<div class="col-sm-3">
								<select class="form-control" id="actividad" name="actividad">
									...
									<option value="1">Ventas por Catálogo</option>
									<option value="13">Venta de ropa, zapatos y bolsas</option>
									<option value="14">Venta de joyería y perfumería</option>
									<option value="20">Venta de Blancos</option>
								</select>
							</div>
							<div class="col-sm-2">
							...
							<div class="col-sm-2">
								<button class="btn btn-purple generar" disabled="disabled" title=""><i class="fa fa-file-excel-o"></i> Generar Excel</button>
							</div>
						...
						<!-- /FILTRO -->
						<div class="row">
							<div class="col-md-12 table-ventas" style="background: white;">
							</div>
						</div>
						<!-- /CONTENIDO PRINCIPAL -->
					</div>
