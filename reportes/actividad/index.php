 ...
 */
define("PAGE_TITLE", "Reporte de Créditos por Actividad Económica");
define("DESCRIPTION", "");
			...
			<div class="container">
				<div class="row">
					<div id="content" class="col-lg-12">
						...
						<!-- CONTENIDO PRINCIPAL -->
						<div class="row">
							<div class="col-md-12" style="width: 3000px;">
								<h3>Cantidad de Personas por Actividad Económica</h3>
						...
						<div class="row">
							<div class="col-md-12" style="width: 3000px;">
								<h3>Promedio de Crédito Otorgado por Actividad Económica</h3>
						...
						<div class="row">
							<div class="col-md-12" style="width: 3000px;">
								<h3>Pago pendiente por Actividad Económica</h3>
