 ...
 */
define("PAGE_TITLE", "Lista de Personas con Pagos Pendientes por Actividad Económica - <br><span class='actividad'></span>");
define("DESCRIPTION", "");
			...
			<div class="container">
				<div class="row">
					<div id="content" class="col-lg-12">
						...
						<!-- CONTENIDO PRINCIPAL -->
						<div class="row">
							<input name="id" type="hidden" id="id" value="<?php echo isset($_GET['act_id']) ? $_GET['act_id'] : '-1' ; ?>">
							<div class="col-md-12 table-pendientes" style="background: white;">
							</div>
