 ...
 */
define("PAGE_TITLE", "Reporte de Créditos por Municipio");
define("DESCRIPTION", "");
			...
			<div class="container">
				<div class="row">
					<div id="content" class="col-lg-12">
						...
						<!-- CONTENIDO PRINCIPAL -->
						<div class="row">
							<div class="col-md-12" style="width: 1900px;">
								<h3>Cantidad de Personas por Municipio</h3>
						...
						<div class="row">
							<div class="col-md-12" style="width: 1900px;">
								<h3>Promedio de Crédito Otorgado por Municipio</h3>
						...
						<div class="row">
							<div class="col-md-12" style="width: 1900px;">
								<h3>Pago Pendientes por Municipio</h3>
