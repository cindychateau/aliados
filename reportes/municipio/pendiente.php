 ...
 */
define("PAGE_TITLE", "Lista de Personas con Pagos Pendientes por Municipio - <br><span class='municipio'></span>");
define("DESCRIPTION", "");
			...
			<div class="container">
				<div class="row">
					<div id="content" class="col-lg-12">
						...
						<!-- CONTENIDO PRINCIPAL -->
						<div class="row">
							<input name="id" type="hidden" id="municipio" value="<?php echo isset($_GET['muni']) ? $_GET['muni'] : '-1' ; ?>">
