 ...
 */
define("PAGE_TITLE", "Colocación del Mes - ");
define("DESCRIPTION", "");
			...
			<div class="container">
				<div class="row">
					<div id="content" class="col-lg-12">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<div class="pull-left">
										<div class="clearfix">
											<h3 class="content-title pull-left"><?php echo(PAGE_TITLE); ?>
											<span class="mes"></span>
											<?php echo $_GET['anio'] ?></h3>
										</div>
						...
						<!-- CONTENIDO PRINCIPAL -->
						<div class="row">
							<input name="mes" type="hidden" id="mes" value="<?php echo isset($_GET['mes']) ? $_GET['mes'] : '-1' ; ?>">
							<input name="anio" type="hidden" id="anio" value="<?php echo isset($_GET['anio']) ? $_GET['anio'] : '-1' ; ?>">
							<div class="col-md-12 table-mes" style="background: white;">
							</div>
