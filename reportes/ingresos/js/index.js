    ...
    $.ajax({
        ...
        success: function(result){
            if(result.error) {
                ...
                $(".table-ventas").html(result.totales);
                $(".cont-loader").removeClass("loader");
                $("input, button").removeAttr("disabled");
            }
    ...
    $.ajax({
        ...
        success: function(result){
            if(result.error) {
                ...
                $(".cont-loader").removeClass("loader");
                $("input, button").removeAttr("disabled");
                $(".cont-guardar").html('<a href="include/reporte-semanal.xlsx"><button class="btn btn-success" title=""><i class="fa fa-save"></i> Guardar Excel</button></a>');
            }
