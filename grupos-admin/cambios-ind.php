 ...
 */
define("PAGE_TITLE", "Editar Crédito Individual");
define("DESCRIPTION", "Edición Crédito Individual");
												...
												<div class="box-body big">
													...
													<div class="form-group">
												  	...
												  	<div class="form-group">
														...
														<div class="col-sm-4">
															<input id="plazo" name="plazo" type="text" class="form-control">
														</div>
												  	</div>
												  	<div class="form-group">
												  	...
												  	<div class="form-group">
														...
														<div class="col-sm-4">
															<div class="input-group">
																<span class="input-group-addon">$</span>
																<input id="ahorro_di" name="ahorro_di" type="text" class="form-control" value="0">
															</div>
														</div>
												  	</div>
												</div>
