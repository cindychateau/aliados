 ...
 */
define("PAGE_TITLE", "Apertura de Créditos");
define("DESCRIPTION", "Administración de los Créditos Vigentes.");
								...
								<div class="page-header">
									...
									<div class="pull-right margin-right-85">
										<?php 	$params = array("link"		=>	"alta.php",
												...
												$params = array("link"		=>	"individual.php",
																"title"		=>	"Nuevo Individual",
																"classes"	=>	"");
												echo $common->printButton($module, "alta", $params);
						...
						<div class="row">
							<div class="col-md-12">
								<div class="row">
									<div class="col-sm-6">
										<label for="nuevo">
											<input type="checkbox" id="nuevo" class="tipo" name="tipo" value="1" checked="checked">
											<button class="btn btn-primary" title="" data-value="1">Nuevo</button>
										</label>
										<label for="recredito">
											<input type="checkbox" id="recredito" class="tipo" name="tipo" value="2" checked="checked">
											<button class="btn btn-purple" title="" data-value="2">Recrédito</button>
										</label>
										<label for="individual">
											<input type="checkbox" id="individual" class="tipo" name="tipo" value="3" checked="checked">
											<button class="btn btn-info" title="" data-value="3">Individual</button>
										</label>
										<label for="reestructura">
											<input type="checkbox" id="reestructura" class="tipo" name="tipo" value="4" checked="checked">
											<button class="btn btn-warning" title="" data-value="4">Reestructura</button>
										</label>
