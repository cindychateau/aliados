 ...
 */
define("PAGE_TITLE", "Nuevo Prospecto");
define("DESCRIPTION", "Alta de nuevo Prospecto");
												 	...
												 	<div class="box border primary">
														...
														<div class="box-body big">
															<div class="form-group">
																...
																<label class="col-sm-2 col-sm-offset-1 control-label">*Fecha</label>
																<div class="col-sm-3">
															...
															<div class="form-group">
														  	...
														  	<!--div class="form-group">
																...
																<div class="col-sm-2">
																	<input id="numero" name="numero" type="text" class="form-control" placeholder="No.">
																</div>
																<div class="col-sm-4">
																...
																<label class="col-sm-2 control-label">*Vivienda</label>
														  		<div class="col-sm-4">
														  			<div class="row">
														  				<div class="col-md-5">
																			<label class="radio">
																				<input type="radio" class="uniform" name="vivienda" value="Propia" checked="checked">
																				Propia 
																			</label>
																		</div>	
																		<div class="col-md-7">
																	...
																	<div class="row">
														  				<div class="col-md-5">		
																			<label class="radio">
																				<input type="radio" class="uniform" name="vivienda" value="Rentada">
																				Rentada 
																			</label>
																		</div>
																		<div class="col-md-7">
