 ...
 */
define("PAGE_TITLE", "Información de Cliente");
define("DESCRIPTION", "Consulta de la información completa del Cliente");
							...
							<div class="col-sm-12">
								<div class="page-header">
									...
									<div class="pull-right margin-right-85">
										<?php
										$btn_guardar = '<a class="guardar" href="#"><button class="btn btn-info"><i class="fa fa-save"></i>Guardar</button></a>';
										echo $common->printLink($module, "cambios", $btn_guardar)
										...
										<div class="wizard-form">
										   <div class="wizard-content">
											  ...
											  <ul class="nav nav-pills nav-justified steps">
											  	 <li class="active">
													<a href="#grupos" data-toggle="tab" class="wiz-step lnk-grupos" data-id="0">
													<span class="step-number">1</span>
													<span class="step-name"><i class="fa fa-check"></i> GRUPO(S)</span>   
													</a>
												 </li>
												 <li>
													<a href="#datos" data-toggle="tab" class="wiz-step lnk-datos" data-id="1">
													<span class="step-number">2</span>
													<span class="step-name"><i class="fa fa-check"></i> Datos Personales</span>   
													</a>
												 </li>
												 <li>
													<a href="#ingresos" data-toggle="tab" class="wiz-step lnk-ingresos" data-id="2">
													<span class="step-number">3</span>
													<span class="step-name"><i class="fa fa-check"></i> Ingresos</span>   
													</a>
												 </li>
												 <li>
													<a href="#referencias" data-toggle="tab" class="wiz-step lnk-referencias" data-id="3">
													<span class="step-number">4</span>
													<span class="step-name"><i class="fa fa-check"></i> Referencias y Garantías</span>   
													</a> 
												 </li>
												 <!--li>
													<a href="#garantias" data-toggle="tab" class="wiz-step lnk-garantias" data-id="4">
											  ...
											  <div class="tab-content">
												...
												<!-- DATOS -->
												 	...
												 	<div class="box border primary">
														...
														<div class="box-body big">
															<div class="form-group">
																...
																<?php echo isset($_GET['status']) ? '<input name="status" type="hidden" id="status" value='.$_GET['status'].'>' : '';?>
															...
															<div class="form-group">
																...
																<div class="col-sm-3">
																	<input id="apellido_pat" name="apellido_pat" type="text" class="form-control" placeholder="Apellido Paterno">
																</div>
																<div class="col-sm-3">
																	<input id="apellido_mat" name="apellido_mat" type="text" class="form-control" placeholder="Apellido Materno">
																</div>
														  	</div>
														  	<div class="form-group">
														  		<label class="col-sm-2 control-label">*Fecha de Nacimiento</label>
																<div class="col-sm-4">
																	<input id="fecha_nac" name="fecha_nac" type="text" class="form-control fecha">
																</div>
																<label class="col-sm-2 control-label">*Número de INE</label>
																<div class="col-sm-4">
																	<input id="ife_num" name="ife_num" type="text" class="form-control">
																</div>
															</div>
															<div class="form-group">
															...
															<div class="form-group">
																...
																<div class="col-sm-4">
																	<select id="edo_civil" name="edo_civil" class="form-control">
															...
															<div class="form-group">
																...
																<div class="cont-otro-esc display-none">
																	<label class="col-sm-2 control-label">Otro</label>
																	<div class="col-sm-4">
																		<input id="otro_escolaridad" name="otro_escolaridad" type="text" class="form-control" placeholder="Especifique Escolaridad">
																	</div>
																</div>
																<label class="col-sm-2 control-label" style="display: none;">E-mail</label>
														  	...
														  	<div class="form-group">
																<label class="col-sm-2 control-label">*Dirección</label>
														  		<div class="col-sm-4 cont-municipios">
														  			<select class="form-control" disabled="disabled">
														  				<option>Cargando...</option>
														  			</select>
														  		</div>
														  		<div class="col-sm-4 cont-colonias">
														  			<select class="form-control" disabled="disabled">
														  				<option>Cargando...</option>
														  			</select>
														  		</div>
														  		<div class="col-sm-2">
																	<input id="otra_colonia" name="otra_colonia" type="text" class="form-control" placeholder="Otra" style="display: none;">
																</div>
														  	</div>
														  	<div class="form-group">
														  		<label class="col-sm-2 control-label"></label>
														  		<div class="col-sm-4">
																	<input id="direccion" name="direccion" type="text" class="form-control" placeholder="Calle">
																</div>
																<div class="col-sm-2">
																	<input id="numero" name="numero" type="text" class="form-control" placeholder="No. Ext">
																</div>
																<div class="col-sm-2">
																	<input id="numero_int" name="numero_int" type="text" class="form-control" placeholder="No. Int">
																</div>
																<div class="col-sm-2">
																	<input id="cp" name="cp" type="text" class="form-control" placeholder="C.P.">
																</div>
																<div class="col-sm-4" style="display: none;">
																	<input id="estado" name="estado" type="text" class="form-control" placeholder="Estado" value="NUEVO LEON">
																</div>
														  	</div>
														  	<div class="form-group">
																<label class="col-sm-2 control-label">*Vivienda</label>
														  		<div class="col-sm-4">
														  			<div class="row">
																		...
																		<div class="col-md-7">
																			<input id="vivienda_nombre" name="vivienda_nombre" type="text" class="form-control" placeholder="Bajo qué Nombre">
																		</div>
																	</div>
																	<div class="row">
														  				<div class="col-md-5">		
														  			...
														  			<div class="row">
														  				<div class="col-sm-6">
														  					<input id="vivienda_num_habitaciones" name="vivienda_num_habitaciones" type="text" class="form-control" placeholder="Num. de Habitaciones">
														  				</div>
														  				<div class="col-sm-6">
														  					<input id="vivienda_num_autos" name="vivienda_num_autos" type="text" class="form-control" placeholder="Num. de Autos">
														  				</div>
														  			</div>
														  		</div>
														  		<label class="col-sm-2 control-label">*Antigüedad en Propiedad</label>
																<div class="col-sm-4">
																	<select id="antiguedad_propiedad" name="antiguedad_propiedad" class="form-control">
																		<option value="0">Menos de 1 año</option>
																		<option value="1">De 1 a 2 años</option>
																		<option value="2">De 3 a 5 años</option>
																		<option value="3">De 6 a 10 años</option>
												 ...
												 <div class="tab-pane" id="ingresos">
												 	<div class="box border primary">
														...
														<div class="box-body big">
															<div class="form-group">
																...
																<div class="col-sm-4 div-actividad">
																	<select class="form-control" disabled><option>Cargando...</option></select>
																</div>
																<div class="act_ventas display-none">
																	<label class="col-sm-2 control-label">*Empresa</label>
																	<div class="col-sm-4">
																		<select class="form-control" id="ventas_empresa" name="ventas_empresa">
																			<option value="Impuls">Impuls</option>
																			<option value="Andrea">Andrea</option>
																			<option value="Cklass">Cklass</option>
																			<option value="Mundo Terra">Mundo Terra</option>
																			<option value="Lavoro">Lavoro</option>
																			<option value="T.T. Blues Jeans">T.T. Blues Jeans</option>
																			<option value="Verochi">Verochi</option>
														  	...
														  	<div class="form-group">
														  		<label class="col-sm-2 control-label">Dirección (Actividad Económica</label>
														  		<div class="col-sm-10">
														  			<input id="act_direccion" name="act_direccion" type="text" class="form-control">
														  		</div>
														  	</div>
														  	<div class="form-group">
														  		<label class="col-sm-2 control-label">*Establecimiento</label>
																<div class="col-sm-4">
																	<select id="act_establecimiento" name="act_establecimiento" class="form-control">
																		<option value="Ambulante">Ambulante</option>
																		<option value="Local">Local</option>
																	</select>
																</div>
																<label class="col-sm-2 control-label">Número de Trabajadores</label>
																<div class="col-sm-4">
																	<input id="act_num_trabajadores" name="act_num_trabajadores" type="text" class="form-control">
																</div>
														  	</div>
														  	<div class="form-group">
													...
													<div class="box border primary">
														...
														<div class="box-body big">
															<div class="form-group">
																<label class="col-sm-2 control-label">Luz</label>
																<div class="col-sm-4">
																	<div class="input-group">
																		<span class="input-group-addon">$</span>
																		<input id="egr_luz" name="egr_luz" type="text" class="form-control">
																	</div>
																</div>
																...
																<div class="input-group">
																		<span class="input-group-addon">$</span>
																		<input id="egr_agua" name="egr_agua" type="text" class="form-control">
																	</div>
																</div>
															</div>
															<div class="form-group">
																...
																<div class="col-sm-4">
																	<div class="input-group">
																		<span class="input-group-addon">$</span>
																		<input id="egr_gas" name="egr_gas" type="text" class="form-control">
																	</div>
																</div>
																...
																<div class="col-sm-4">
																	<div class="input-group">
																		<span class="input-group-addon">$</span>
																		<input id="egr_transporte" name="egr_transporte" type="text" class="form-control">
																	</div>
																</div>
															</div>
															<div class="form-group">
																<label class="col-sm-2 control-label">Alimentos</label>
																<div class="col-sm-4">
																	<div class="input-group">
																		<span class="input-group-addon">$</span>
																		<input id="egr_alimentos" name="egr_alimentos" type="text" class="	form-control">
																	</div>
																</div>
																<label class="col-sm-2 control-label">Celular</label>
																<div class="col-sm-4">
																	<div class="input-group">
																		<span class="input-group-addon">$</span>
																		<input id="egr_celular" name="egr_celular" type="text" class="form-control">
																	</div>
																</div>
															</div>
															<div class="form-group">
																<label class="col-sm-2 control-label">Recreación</label>
																<div class="col-sm-4">
																	<div class="input-group">
																		<span class="input-group-addon">$</span>
																		<input id="egr_recreacion" name="egr_recreacion" type="text" class="form-control">
																	</div>
																</div>
															</div>
														</div>
													...
													<div class="box border primary">
														...
														<div class="box-body big">
															<div class="form-group">
																...
																<!--label class="col-sm-2 control-label">¿Es Cliente Aliado?</label>
																<div class="col-sm-2 cont_ref_cliente_1">
																	<div class="make-switch switch-large has-switch" data-off="danger" data-on="success" data-off-label="<i class='fa fa-times'></i>" data-on-label="<i class='fa fa-check'></i>">
																		<input id="referencia_cliente_1" name="referencia_cliente_1" type="checkbox">
																	</div>
																</div-->
														  	</div>
														  	<div class="form-group">
																...
																<div class="col-sm-4">
																	<input id="referencia_relacion_1" name="referencia_relacion_1" type="text" class="form-control">
																</div>
																<label class="col-sm-2 control-label">Teléfono</label>
																<div class="col-sm-4">
													...
													<div class="box border primary">
														...
														<div class="box-body big">
															<div class="form-group">
																...
																<!--label class="col-sm-2 control-label">¿Es Cliente Aliado?</label>
																<div class="col-sm-2 cont_ref_cliente_2">
																	<div class="make-switch switch-large has-switch" data-off="danger" data-on="success" data-off-label="<i class='fa fa-times'></i>" data-on-label="<i class='fa fa-check'></i>">
																		<input id="referencia_cliente_2" name="referencia_cliente_2" type="checkbox">
																	</div>
																</div-->
														  	</div>
														  	<div class="form-group">
														  		<label class="col-sm-2 control-label">Relación</label>
																<div class="col-sm-4">
																	<input id="referencia_relacion_2" name="referencia_relacion_2" type="text" class="form-control">
																</div>
																<label class="col-sm-2 control-label">Teléfono</label>
																<div class="col-sm-4">
													...
													<div class="box border primary">
														...
														<div class="box-body big">
															<div class="form-group">
																...
																<!--label class="col-sm-2 control-label">¿Es Cliente Aliado?</label>
																<div class="col-sm-2 cont_ref_cliente_3">
																	<div class="make-switch switch-large has-switch" data-off="danger" data-on="success" data-off-label="<i class='fa fa-times'></i>" data-on-label="<i class='fa fa-check'></i>">
																		<input id="referencia_cliente_3" name="referencia_cliente_3" type="checkbox">
																	</div>
																</div-->
														  	</div>
														  	<div class="form-group">
														  		<label class="col-sm-2 control-label">Relación</label>
																<div class="col-sm-4">
																	<input id="referencia_relacion_3" name="referencia_relacion_3" type="text" class="form-control">
																</div>
																<label class="col-sm-2 control-label">Teléfono</label>
																<div class="col-sm-4">
													...
													<div class="box border primary">
														...
														<div class="box-body big">
															<div class="form-group">
																...
																<!--label class="col-sm-2 control-label">¿Es Cliente Aliado?</label>
																<div class="col-sm-2 cont_ref_cliente_4">
																	<div class="make-switch switch-large has-switch" data-off="danger" data-on="success" data-off-label="<i class='fa fa-times'></i>" data-on-label="<i class='fa fa-check'></i>">
																		<input id="referencia_cliente_4" name="referencia_cliente_4" type="checkbox">
																	</div>
																</div-->
														  	</div>
														  	<div class="form-group">
														  		<label class="col-sm-2 control-label">Relación</label>
																<div class="col-sm-4">
																	<input id="referencia_relacion_4" name="referencia_relacion_4" type="text" class="form-control">
																</div>
																<label class="col-sm-2 control-label">Teléfono</label>
																<div class="col-sm-4">
												...
												<!-- GARANTIAS -->
												 <!--div class="tab-pane" id="garantias">
													 ...
													 <div class="box border primary">
														...
														<div class="box-body big">
															...
															<!--div class="form-group">
																...
																<div class="col-sm-2 cont-rechazar">
													...
													<div class="box border primary" style="display: none;">
														<div class="box-title">
															JUICIOS SUBJETIVOS CUANTIFICADOS
														</div>
														<div class="box-body big">
															<div class="form-group">
																<label class="col-sm-2 control-label">Riesgo Crediticio</label>
																<div class="col-sm-4">
																	<select id="jsub_riesgo" name="jsub_riesgo" class="form-control">
																		<option value="Bajo">Bajo</option>
																		<option value="Moderado">Moderado</option>
																		<option value="Alto">Alto</option>
																	</select>
																</div>
																<label class="col-sm-2 control-label">Honestidad del cliente</label>
																<div class="col-sm-4">
																	<select id="jsub_honestiadad" name="jsub_honestiadad" class="form-control">
																		<option value="Bajo">Bajo</option>
																		<option value="Moderado">Moderado</option>
																		<option value="Alto">Alto</option>
																	</select>
															...
															<div class="form-group">
																<label class="col-sm-2 control-label">Calidad de referencias</label>
																<div class="col-sm-4">
																	<select id="jsub_calidad_ref" name="jsub_calidad_ref" class="form-control">
																		<option value="Bajo">Bajo</option>
																		<option value="Moderado">Moderado</option>
																		<option value="Alto">Alto</option>
																	</select>
																</div>
																<label class="col-sm-2 control-label">Habilidades empresariales</label>
																<div class="col-sm-4">
																	<select id="jsub_habilidad_empr" name="jsub_habilidad_empr" class="form-control">
																		<option value="Bajo">Bajo</option>
																		<option value="Moderado">Moderado</option>
																		<option value="Alto">Alto</option>
																	</select>
															...
															<div class="form-group">
																<label class="col-sm-2 control-label">Calidad del Negocio</label>
																<div class="col-sm-4">
																	<select id="jsub_calidad_neg" name="jsub_calidad_neg" class="form-control">
																		<option value="Bajo">Bajo</option>
																		<option value="Moderado">Moderado</option>
																		<option value="Alto">Alto</option>
																	</select>
																</div>
																<label class="col-sm-2 control-label">Entendimiento del tipo de crédito</label>
																<div class="col-sm-4">
																	<select id="jsub_entendimiento_cred" name="jsub_entendimiento_cred" class="form-control">
																		<option value="Bajo">Bajo</option>
																		<option value="Moderado">Moderado</option>
																		<option value="Alto">Alto</option>
																	</select>
															...
															<div class="form-group">
																<label class="col-sm-2 control-label">Inver. recientes en casa o negocio</label>
																<div class="col-sm-4">
																	<select id="jsub_inver_rec" name="jsub_inver_rec" class="form-control">
																		<option value="Bajo">Bajo</option>
																		<option value="Moderado">Moderado</option>
																		<option value="Alto">Alto</option>
																	</select>
																</div>
																<label class="col-sm-2 control-label">Entendimiento de tasas y montos</label>
																<div class="col-sm-4">
																	<select id="jsub_entendimiento_tasas" name="jsub_entendimiento_tasas" class="form-control">
																		<option value="Bajo">Bajo</option>
																		<option value="Moderado">Moderado</option>
																		<option value="Alto">Alto</option>
																	</select>
															...
															<div class="form-group">
																<label class="col-sm-2 control-label">Apoyo familiar</label>
																<div class="col-sm-4">
																	<select id="jsub_apoyo_fam" name="jsub_apoyo_fam" class="form-control">
																		<option value="Bajo">Bajo</option>
																		<option value="Moderado">Moderado</option>
																		<option value="Alto">Alto</option>
																	</select>
																</div>
																<label class="col-sm-2 control-label">Apariencia de casa y negocio</label>
																<div class="col-sm-4">
																	<select id="jsub_apariencia_casa" name="jsub_apariencia_casa" class="form-control">
																		<option value="Bajo">Bajo</option>
																		<option value="Moderado">Moderado</option>
																		<option value="Alto">Alto</option>
																	</select>
