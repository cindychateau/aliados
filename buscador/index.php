 ...
 */
define("PAGE_TITLE", "Busqueda de Clientes");
define("DESCRIPTION", "A través de la barra de búsqueda, encuentre los clientes y toda su información.");
						...
						<div class="row">
							<div class="panel panel-default">
								  <div class="panel-body">
									<div class="row">
									   <div class="col-md-12 container-clientes">
										  	<!--form class="form-horizontal" id="form-search" name="form-search" action="include/Libs.php/accion=searchClient">
										  		<div class="form-group">
										  			<div class="col-sm-12">
										  				<div class="input-group">
										  				<input class="form-control" name="nombre" id="nombre" type="text" placeholder="Ingrese Nombre...">
															<span class="input-group-btn">
																<button class="btn btn-primary buscar" type="button">Buscar <i class="fa fa-search"></i></button>
															</span>
										  				</div>
										  			</div>
										  		</div>
