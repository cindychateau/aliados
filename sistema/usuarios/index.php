...
define("DESCRIPTION", "Administración de los usuarios del sistema.");
									...
									<div class="box-body">
										<div class="tabbable header-tabs">
											<ul class="nav nav-tabs">
												...
												<li class="active"><a href="#box_tab1" data-toggle="tab"><i class="fa fa-users"></i> <span class="hidden-inline-mobile">Usuarios</span></a></li>
											</ul>
