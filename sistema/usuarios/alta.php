...
define("DESCRIPTION", "Alta de nuevo de Usuario");
			...
			<div class="container">
				<div class="row">
					<div id="content" class="col-lg-12">
						...
						<div class="row">
							<div class="col-md-12">
								<form class="form-horizontal" name="form-usuario" action="include/Libs.php/accion=saveRecord">
									<div class="row">
										<div class="col-md-8 center-box">
											<div class="margin-bottom-15">
												<small>*Todos los campos son obligatorios.</small><br>
												<small>**La contraseña debe contener al menos un número y una letra mayúscula.</small>
											</div>
											<div class="box border primary">
												...
												<div class="box-body big">
													<div class="form-group">
												  	...
												  	<div class="form-group">
														<label class="col-sm-2 control-label">Confirmación de Password</label>
														<div class="col-sm-10">
															<input id="conf-pswd" name="conf-pswd" type="password" class="form-control">
														</div>
												  	</div>
												  	<div class="form-group">
														<label class="col-sm-2 control-label">Perfil de Usuario</label>
														<div id="container-sel" class="col-sm-10">
															<select class="form-control disabled" disabled>
																<option>Cargando...</option>
															</select>
														</div>
													</div>
													<div class="form-group display-none cont-direccion">
