 ...
 */
define("PAGE_TITLE", "Edición de Pagos");
define("DESCRIPTION", "Editar pagos de una persona");
			...
			<div class="container">
				<div class="row">
					<div id="content" class="col-lg-12">
						...
						<!-- /PAGE HEADER -->
						<!-- CONTENIDO PRINCIPAL -->
						<input type="hidden" id="per_id" name="per_id" value="<?php echo isset($_GET['per_id']) ? $_GET['per_id'] : '-1' ; ?>">
						<input type="hidden" id="gru_id" name="gru_id" value="<?php echo isset($_GET['gru_id']) ? $_GET['gru_id'] : '-1' ; ?>">
						<div class="row">
							<div class="col-sm-12">
								<h3><span class="nombre"></span> - GRUPO : <?php echo isset($_GET['gru_id']) ? $_GET['gru_id'] : '-1' ; ?></h3>
							</div>
						</div>
						<hr>
						<div class="row">
							<form id="pagosDesgl">
								...
								<button id="guardar" class="btn btn-success"><i class="fa fa-save"></i>Guardar Pagos</button>
						</div>
						<!-- /CONTENIDO PRINCIPAL -->
					</div>
				</div>
